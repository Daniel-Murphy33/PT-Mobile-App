  ...
  import EditWorkoutScreen from '../WorkoutTab/EditWorkoutScreen';
    ...
    return (
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.workoutContainer}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Edit Workout", { day, id, exercises, name, trainingType, notes })}>
            <Text style={styles.editButton}>Edit Workout</Text>
          </TouchableOpacity>
        </View>
